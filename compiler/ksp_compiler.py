...
class KSPCompiler(object):
    ...
    def generate_compiled_code(self):
        ...
        # Add if(1=1) workaround to entire ICB. This is because autogenerated ICB commands like for function locals can't be placed in on dev-side.
        ...
        for l in lines:
            if 'on init' in l:
                init_block = True
                new_lines.append(l)
                new_lines.append('if(1=1)')
            elif 'end on' in l and init_block:
                init_block = False
